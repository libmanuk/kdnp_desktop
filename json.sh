...
air county news 'bash json.sh xt7z348gg47v ada'
...
echo "{\"lccn_link_s\":\"http:\/\/chroniclingamerica.loc.gov\/lccn\/$mlccn\/\",\"aip_t\":\"\",\"id\":\"$ark\",\"lccn_t\":\"$mlccn\",\"printurl_t\":\"https:\/\/archive.org\/download\/$ark\/$ark.pdf\",\"thumbnailurl_t\":\"https:\/\/archive.org\/download\/$ark\/$ark.gif\",\"objecturl_t\":\"https:\/\/archive.org\/stream\/$ark#page\/n0\/mode\/1up\",\"abbreviation_t\":\"$code\",\"control_t\":\"$code$mdate 01\",\"text\":\"date ($mdate) newspaper_issue $text\",\"edition_s\":\"01\",\"collection_s\":\"$mcollection\",\"title_t\":\"$mcollection\",\"region_s\":\"$mregion\",\"county_s\":\"$mcounty\",\"doctitle_t\":\"$mcollection, $mdate\",\"month_s\":\"$mmonth\",\"year_s\":\"$myear\",\"day_s\":\"$mday\",\"pages_s\":\"$mpages\",\"funders_t\":\"University of Kentucky\",\"partners_t\":\"\"}" >$jsonfile
